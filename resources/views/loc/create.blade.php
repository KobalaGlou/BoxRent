                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form action="{{ route('loc.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="adresse" id="adresse" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required></textarea>
                        </div>

                        <div class="mb-4">
                            <label for="compte_bancaire" class="block text-gray-700 font-bold mb-2">Compte Bancaire :</label>
                            <input type="text" name="compte_bancaire" id="compte_bancaire" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                        </div>
